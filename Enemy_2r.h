...
class Enemy_2r: public Enemy_1n{//shot 없음.
    public:
        Enemy_2r(int y_value, int x_value, int frame_value, int can_shot=false, char type_shape='r', int hp_value=5, int speed_value=3, int is_buffed, int buff_speed_value=0, int score_value=2, int live_state=true)
