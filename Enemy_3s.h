...
class Enemy_3s: public Enemy_2r{//shot 있음.
    public:
        Enemy_3s(int y_value, int x_value, int frame_value, int can_shot=true, char type_shape='s', int hp_value=4, int speed_value=9, int is_buffed, int buff_speed_value=0, int score_value=3, int live_state=true)
