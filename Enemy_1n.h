...
class Enemy_1n: public Enemy{//shot 없음.
    public:
        Enemy_1n(int y_value, int x_value, int frame_value, int can_shot=false, char type_shape='n', int hp_value=10, int speed_value=0, int is_buffed, int buff_speed_value=0, int score_value=1, int live_state=true)
