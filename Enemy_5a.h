...
class Enemy_5a: public Enemy_1n{//shot 없음. buffer. 다른 enemy buff해서 capital size type으로 변경.
    public:
        Enemy_5a(int y_value, int x_value, int frame_value, int can_shot=true, char type_shape='a', int hp_value=8, int speed_value=0, int is_buffed=false, int buff_speed=6, int score_value=5, int live_state=true)
